...
## PERMANOVA
# Test whether overall mb composition differs by 1-year FFMI loss group
adonis_v0 <- vegan::adonis2(bray_v0 ~ perc_change_ffmi_v4_group, data = mb_meta_v0, permutations = 999, by = "terms")
...
bray_ffmi_loss_v0 <- bray_2_v0 |> 
  ...
  stat_ellipse(
    geom = "polygon", 
    aes(color = perc_change_ffmi_v4_group, fill = perc_change_ffmi_v4_group),
...
ggsave(bray_ffmi_loss_v0, filename = "graphs/betadiversity/bray_by_ffmi_loss_v4.pdf", width = 10, height = 7)