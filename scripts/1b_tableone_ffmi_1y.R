...
# Data
baria_muscle_wide <- readRDS(
  "data/processed_data/BARIA_muscle_wide.RDS"
)
...
t1_ffmi_loss_vars_v0 <- baria_muscle_wide |>
  select(
    ...
    t2d_v0,
    hba1c_mmolmol_v0,
    glucose_mmoll_mmt_0_v0,
    insulin_pmoll_mmt_0_v0,
    homa_ir_v0,
    homa_b_v0
  ) |>
...
write.csv(
  t1_ffmi_loss_1y_v0_matrix,
  file = "results/tables/t1_ffmi_loss_1y_v0_matrix.csv",
  row.names = TRUE
)
