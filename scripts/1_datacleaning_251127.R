# Data cleaning for BARIA Project on weight trajectories
...
getwd()
baria_clinical_data_raw <- readRDS("/Users/Anna/Documents/Amsterdam UMC PhD/BARIA/baria_muscle/data/BARIA.clinical.2024-12-09.723.2043.RDS")
head(baria_clinical_data_raw)
...
baria_v0 <- baria_clinical_data_raw |> 
  select(id = Subject_ID,
    ...
    # v3 = 6 months CONTINUTE FROM HERE
    bmi_v3 = V3_bmi,
  ...
  mutate(
    ...
    # v0, v4, v5, v6 FFMI & FMI --> change variable names
...
ggplot(baria_baseline, aes(x = hba1c_percent_baseline)) +
...
baria_v0_with_medication_notypos <- baria_v0 |>
...
baria_muscle_clean <- baria_v0_with_medication_clean
